...
sudo apt-get install -y vim curl awscli python3-pip tmux fonts-powerline git-lfs tree htop gpustat
...
# github profile
git config --global user.email "ghlrobin@gmail.com"
git config --global user.name "ghlrobin"
